...
export const es: TranslationResources = {
  ...
  reports: {
    attachments: {
      ...
      audio: 'Audio', camera: 'Cámara', cameraPermission: 'Permite el acceso a la cámara para tomar una foto.', confirmFailed: 'No se pudo verificar el archivo adjunto', documentFailed: 'No se pudo añadir el archivo', empty: 'Aún no hay archivos adjuntos', file: 'Archivo', invalid: 'Archivo adjunto no compatible', microphonePermission: 'Permite el acceso al micrófono para grabar audio.', permissionTitle: 'Permiso necesario', photo: 'Foto', photoConversionFailed: 'No se pudo convertir esta foto a un formato compatible', photoFailed: 'No se pudo añadir la foto', recording: 'Grabando · {{duration}}', recordingFailed: 'No se pudo grabar el audio', remove: 'Eliminar', removeFailed: 'No se pudo eliminar el archivo adjunto',
    ...
    generation: {
      ...
      cancel: 'Cancelar generación', cancelFailed: 'No se pudo cancelar la generación', credits: '{{count}} créditos', description: 'Convierte tus notas y archivos adjuntos en un informe PDF listo.',
