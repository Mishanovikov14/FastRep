...
export const fr: TranslationResources = {
  ...
  reports: {
    attachments: {
      ...
      audio: 'Audio', camera: 'Appareil photo', cameraPermission: "Autorisez l’accès à l’appareil photo pour prendre une photo.", confirmFailed: 'Impossible de vérifier la pièce jointe', documentFailed: 'Impossible d’ajouter le fichier', empty: 'Aucune pièce jointe', file: 'Fichier', invalid: 'Pièce jointe non prise en charge', microphonePermission: "Autorisez l’accès au microphone pour enregistrer un audio.", permissionTitle: 'Autorisation requise', photo: 'Photo', photoConversionFailed: 'Impossible de convertir cette photo dans un format pris en charge', photoFailed: 'Impossible d’ajouter la photo', recording: 'Enregistrement · {{duration}}', recordingFailed: 'Impossible d’enregistrer l’audio', remove: 'Supprimer', removeFailed: 'Impossible de supprimer la pièce jointe',
    ...
    generation: {
      ...
      cancel: 'Annuler la génération', cancelFailed: 'Impossible d’annuler la génération', credits: '{{count}} crédits', description: 'Transformez vos notes et pièces jointes en un rapport PDF soigné.',
