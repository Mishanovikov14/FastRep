...
export const uk: TranslationResources = {
  ...
  reports: {
    attachments: {
      ...
      audio: 'Аудіо',
      camera: 'Камера',
      cameraPermission: 'Дозвольте доступ до камери, щоб зробити фото.',
      confirmFailed: 'Не вдалося перевірити вкладення',
      documentFailed: 'Не вдалося додати файл',
      empty: 'Вкладень ще немає',
      file: 'Файл',
      invalid: 'Вкладення не підтримується',
      microphonePermission: 'Дозвольте доступ до мікрофона для запису аудіо.',
      permissionTitle: 'Потрібен дозвіл',
      photo: 'Фото',
      photoConversionFailed: 'Не вдалося перетворити це фото на підтримуваний формат',
      photoFailed: 'Не вдалося додати фото',
      recording: 'Запис · {{duration}}',
      recordingFailed: 'Не вдалося записати аудіо',
      remove: 'Видалити',
      removeFailed: 'Не вдалося видалити вкладення',
      states: {
        CONFIRMING: 'Перевірка',
        FAILED: 'Помилка завантаження',
        LOCAL: 'Очікування',
        READY: 'Готово',
        REQUESTING_UPLOAD: 'Підготовка',
      ...
      validation: {
        ...
        imageDimensionsTooLarge: 'Зображення може бути до 4096 × 4096 пікселів.',
        missingFileMetadata: 'Не вдалося прочитати вибраний файл.',
        reportTotalTooLarge: 'Загальний розмір вкладень звіту — до 150 МБ.',
        tooManyFiles: 'Досягнуто ліміту вкладень цього типу.',
        unsupportedType: 'Виберіть підтримуваний формат файлу.',
      },
    },
    ...
    duplicate: {
      action: 'Дублювати',
      failed: 'Не вдалося дублювати звіт',
    },
    edit: {
      action: 'Редагувати',
      notEditableDescription: 'Редагувати можна лише чернетки та звіти з помилкою.',
      notEditableTitle: 'Цей звіт уже фінальний',
    ...
    generation: {
      ...
      cancelFailed: 'Не вдалося скасувати генерацію',
      credits: 'Кредитів: {{count}}',
      description: 'Перетворіть нотатки та вкладення на готовий PDF-звіт.',
      rejectedAttachments: 'Повторіть або видаліть позначене вкладення перед генерацією звіту.',
      errors: {
        GENERATION_ALREADY_ACTIVE: 'Генерація цього звіту вже виконується.',
        GENERATION_CREDITS_EXHAUSTED: 'Немає доступних кредитів генерації.',
        GENERATION_CREDIT_RESERVATION_FAILED: 'Не вдалося зарезервувати кредит. Спробуйте ще раз.',
        GENERATION_DAILY_LIMIT_REACHED: 'Досягнуто денного ліміту генерацій.',
        GENERATION_DISABLED: 'Генерація звітів тимчасово недоступна.',
        GENERATION_QUEUE_UNAVAILABLE: 'Сервіс генерації тимчасово недоступний.',
        GENERATION_RATE_LIMITED: 'Забагато запитів. Зачекайте та повторіть.',
        REPORT_HAS_NO_CONTENT: 'Спочатку додайте нотатки або вкладення.',
        REPORT_HAS_PENDING_UPLOADS: 'Дочекайтеся завершення завантаження вкладень.',
        REPORT_HAS_REJECTED_ASSETS: 'Видаліть відхилені вкладення.',
        REPORT_NOT_EDITABLE: 'Звіт не можна згенерувати в поточному стані.',
        REPORT_TEMPORARILY_LOCKED: 'Звіт тимчасово недоступний після повторних помилок.',
        generic: 'Не вдалося згенерувати звіт. Спробуйте ще раз.',
      },
      failedDescription: 'Генерація не вдалася. Відредагуйте джерела та повторіть.',
      generate: 'Згенерувати звіт',
      generated: 'Звіт згенеровано',
      lock: {
        message: 'Цей звіт кілька разів не вдалося створити. Повторіть через {{minutes}} хв.',
        title: 'Звіт тимчасово недоступний',
      },
      outputReady: 'Ваш звіт готовий',
      retry: 'Спробувати ще раз',
      stages: {
        analyzing: 'Аналіз вкладень…',
        completed: 'Завершено',
        creatingPdf: 'Створення PDF…',
        finalizing: 'Завершення…',
        generating: 'Генерація звіту…',
        preparing: 'Підготовка…',
        transcribing: 'Розшифровка аудіо…',
      },
      startFailed: 'Помилка генерації',
      title: 'AI-звіт',
    },
    list: {
    ...
    output: {
      open: 'Відкрити звіт',
      openFailed: 'Не вдалося відкрити звіт',
