...
export const en: TranslationResources = {
  ...
  reports: {
    attachments: {
      ...
      confirmFailed: 'Could not verify attachment',
      documentFailed: 'Could not add file',
      empty: 'No attachments yet',
      file: 'File',
      invalid: 'Attachment not supported',
      microphonePermission: 'Allow microphone access to record audio.',
      permissionTitle: 'Permission required',
      photo: 'Photo',
      photoConversionFailed: 'Could not convert this photo to a supported format',
      photoFailed: 'Could not add photo',
      ...
      states: {
        ...
        LOCAL: 'Waiting',
        READY: 'Ready',
        REQUESTING_UPLOAD: 'Preparing',
        UPLOADING: 'Uploading',
      },
      stop: 'Stop',
      title: 'Attachments',
      tryAgain: 'Try again.',
      types: { AUDIO: 'Audio', DOCUMENT: 'File', IMAGE: 'Photo' },
      uploadFailed: 'Attachment upload failed',
      viewerUnavailable: 'No app on this device can open this file type',
      validation: {
        audioDurationTooLong: 'Audio recordings can be up to 20 minutes.',
        fileTooLarge: 'This file is too large.',
        imageDimensionsTooLarge: 'Images can be up to 4096 × 4096 pixels.',
        missingFileMetadata: 'The selected file could not be read.',
        reportTotalTooLarge: 'Attachments for one report can total up to 150 MB.',
        tooManyFiles: 'This report has reached the limit for this attachment type.',
    ...
    duplicate: {
      action: 'Duplicate',
      failed: 'Could not duplicate report',
    },
    edit: {
      action: 'Edit',
      notEditableDescription: 'Only draft and failed reports can be edited.',
      notEditableTitle: 'This report is final',
    ...
    generation: {
      ...
      cancelFailed: 'Could not cancel generation',
      credits: '{{count}} credits',
      description: 'Turn your notes and attachments into a polished PDF report.',
      rejectedAttachments: 'Retry or delete the marked attachment before generating the report.',
      errors: {
        GENERATION_ALREADY_ACTIVE: 'A generation is already running for this report.',
        GENERATION_CREDITS_EXHAUSTED: 'You have no generation credits available.',
        GENERATION_CREDIT_RESERVATION_FAILED: 'A generation credit could not be reserved. Try again.',
        GENERATION_DAILY_LIMIT_REACHED: 'The daily generation limit has been reached.',
        GENERATION_DISABLED: 'Report generation is temporarily unavailable.',
        GENERATION_QUEUE_UNAVAILABLE: 'The generation service is temporarily unavailable.',
        GENERATION_RATE_LIMITED: 'Too many requests. Wait a moment and try again.',
        REPORT_HAS_NO_CONTENT: 'Add notes or at least one attachment first.',
        REPORT_HAS_PENDING_UPLOADS: 'Wait for every attachment to finish uploading.',
        REPORT_HAS_REJECTED_ASSETS: 'Remove rejected attachments before generating.',
        REPORT_NOT_EDITABLE: 'This report cannot be generated in its current state.',
        REPORT_TEMPORARILY_LOCKED: 'This report is temporarily unavailable after repeated failures.',
        generic: 'The report could not be generated. Try again.',
      },
      failedDescription: 'Generation failed. You can edit the sources and try again.',
      generate: 'Generate report',
      generated: 'Report generated',
      lock: {
        message: 'This report failed several times. Try again in {{minutes}} minutes.',
        title: 'Report temporarily unavailable',
      },
      outputReady: 'Your report is ready',
      retry: 'Try again',
      stages: {
        analyzing: 'Analyzing attachments…',
        completed: 'Completed',
    ...
    output: {
      ...
      tryAgain: 'Download the PDF again and retry.',
      viewerUnavailable: 'No app on this device can open PDF files',
    },
    status: {
      draft: 'Draft',
      failed: 'Failed',
