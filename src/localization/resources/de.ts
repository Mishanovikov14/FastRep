...
export const de: TranslationResources = {
  ...
  reports: {
    attachments: {
      ...
      audio: 'Audio', camera: 'Kamera', cameraPermission: 'Erlaube den Kamerazugriff, um ein Foto aufzunehmen.', confirmFailed: 'Anhang konnte nicht geprüft werden', documentFailed: 'Datei konnte nicht hinzugefügt werden', empty: 'Noch keine Anhänge', file: 'Datei', invalid: 'Anhang wird nicht unterstützt', microphonePermission: 'Erlaube den Mikrofonzugriff für Audioaufnahmen.', permissionTitle: 'Berechtigung erforderlich', photo: 'Foto', photoConversionFailed: 'Dieses Foto konnte nicht in ein unterstütztes Format konvertiert werden', photoFailed: 'Foto konnte nicht hinzugefügt werden', recording: 'Aufnahme · {{duration}}', recordingFailed: 'Audio konnte nicht aufgenommen werden', remove: 'Entfernen', removeFailed: 'Anhang konnte nicht entfernt werden',
    ...
    generation: {
      ...
      cancel: 'Generierung abbrechen', cancelFailed: 'Generierung konnte nicht abgebrochen werden', credits: '{{count}} Credits', description: 'Erstelle aus Notizen und Anhängen einen fertigen PDF-Bericht.',
