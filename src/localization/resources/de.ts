...
export const de: TranslationResources = {
  ...
  reports: {
    attachments: {
      accessFailed: 'Anhang konnte nicht geöffnet werden',
      attentionRequired: 'Anhang erfordert Aufmerksamkeit',
      audioRecordingName: 'Audioaufnahme',
      delete: 'Löschen',
      deleteAccessibility: '{{name}} löschen',
      deleteConfirmation: 'Diese Datei wird bei künftigen Berichtsgenerierungen nicht mehr berücksichtigt.',
      deleteTitle: 'Anhang löschen?',
      fileName: 'Datei',
      pauseAccessibility: '{{name}} pausieren',
      photoName: 'Foto',
      playFailed: 'Audio konnte nicht abgespielt werden',
      playAccessibility: '{{name}} abspielen',
      rejectionReasons: {
        expired: 'Der Upload ist abgelaufen. Füge den Anhang erneut hinzu.',
        invalidContent: 'Der Dateiinhalt konnte nicht verarbeitet werden.',
        limitExceeded: 'Das Anhangslimit wurde überschritten.',
        processingFailed: 'Dieser Anhang konnte nicht verarbeitet werden.',
        storageUnavailable: 'Der Speicher war vorübergehend nicht verfügbar.',
        tooLarge: 'Dieser Anhang ist zu groß.',
        unsupportedType: 'Dieser Dateityp wird nicht unterstützt.',
      },
      removed: 'Anhang gelöscht',
      retryAccessibility: '{{name}} erneut versuchen',
      audio: 'Audio',
      camera: 'Kamera',
      cameraPermission: 'Erlaube den Kamerazugriff, um ein Foto aufzunehmen.',
      confirmFailed: 'Anhang konnte nicht geprüft werden',
      documentFailed: 'Datei konnte nicht hinzugefügt werden',
      empty: 'Noch keine Anhänge',
      file: 'Datei',
      invalid: 'Anhang wird nicht unterstützt',
      microphonePermission: 'Erlaube den Mikrofonzugriff für Audioaufnahmen.',
      permissionTitle: 'Berechtigung erforderlich',
      photo: 'Foto',
      photoConversionFailed: 'Dieses Foto konnte nicht in ein unterstütztes Format konvertiert werden',
      photoFailed: 'Foto konnte nicht hinzugefügt werden',
      recording: 'Aufnahme · {{duration}}',
      recordingFailed: 'Audio konnte nicht aufgenommen werden',
      remove: 'Entfernen',
      removeFailed: 'Anhang konnte nicht entfernt werden',
      states: {
        CONFIRMING: 'Prüfen',
        FAILED: 'Upload fehlgeschlagen',
        LOCAL: 'Warten',
        READY: 'Bereit',
        REQUESTING_UPLOAD: 'Vorbereiten',
        UPLOADING: 'Hochladen',
      },
      stop: 'Stoppen',
      title: 'Anhänge',
      ...
      validation: {
        ...
        imageDimensionsTooLarge: 'Bilder dürfen höchstens 4096 × 4096 Pixel groß sein.',
        missingFileMetadata: 'Die ausgewählte Datei konnte nicht gelesen werden.',
        reportTotalTooLarge: 'Anhänge eines Berichts dürfen insgesamt 150 MB groß sein.',
        tooManyFiles: 'Das Limit für diesen Anhangstyp ist erreicht.',
        unsupportedType: 'Wähle ein unterstütztes Dateiformat.',
      },
    },
    fallbackTitle: 'Neuer Bericht',
    card: {
    ...
    duplicate: {
      action: 'Duplizieren',
      failed: 'Bericht konnte nicht dupliziert werden',
    },
    edit: {
      action: 'Bearbeiten',
      notEditableDescription: 'Nur Entwürfe und fehlgeschlagene Berichte können bearbeitet werden.',
      notEditableTitle: 'Dieser Bericht ist final',
    ...
    generation: {
      rejectedAttachments: 'Wiederhole oder lösche den markierten Anhang, bevor du den Bericht generierst.',
      cancel: 'Generierung abbrechen',
      cancelFailed: 'Generierung konnte nicht abgebrochen werden',
      credits: '{{count}} Credits',
      description: 'Erstelle aus Notizen und Anhängen einen fertigen PDF-Bericht.',
      errors: {
        GENERATION_ALREADY_ACTIVE: 'Für diesen Bericht läuft bereits eine Generierung.',
        GENERATION_CREDITS_EXHAUSTED: 'Keine Generierungs-Credits verfügbar.',
        GENERATION_CREDIT_RESERVATION_FAILED: 'Ein Credit konnte nicht reserviert werden. Versuche es erneut.',
        GENERATION_DAILY_LIMIT_REACHED: 'Das tägliche Generierungslimit ist erreicht.',
        GENERATION_DISABLED: 'Die Berichtsgenerierung ist vorübergehend nicht verfügbar.',
        GENERATION_QUEUE_UNAVAILABLE: 'Der Generierungsdienst ist vorübergehend nicht verfügbar.',
        GENERATION_RATE_LIMITED: 'Zu viele Anfragen. Warte kurz und versuche es erneut.',
        REPORT_HAS_NO_CONTENT: 'Füge zuerst Notizen oder einen Anhang hinzu.',
        REPORT_HAS_PENDING_UPLOADS: 'Warte, bis alle Anhänge hochgeladen sind.',
        REPORT_HAS_REJECTED_ASSETS: 'Entferne abgelehnte Anhänge.',
        REPORT_NOT_EDITABLE: 'Dieser Bericht kann in seinem aktuellen Zustand nicht generiert werden.',
        REPORT_TEMPORARILY_LOCKED: 'Dieser Bericht ist nach wiederholten Fehlern vorübergehend gesperrt.',
        generic: 'Der Bericht konnte nicht generiert werden. Versuche es erneut.',
      },
      failedDescription: 'Die Generierung ist fehlgeschlagen. Bearbeite die Quellen und versuche es erneut.',
      generate: 'Bericht generieren',
      generated: 'Bericht generiert',
      lock: {
        message: 'Dieser Bericht ist mehrfach fehlgeschlagen. Versuche es in {{minutes}} Minuten erneut.',
        title: 'Bericht vorübergehend nicht verfügbar',
      },
      outputReady: 'Dein Bericht ist fertig',
      retry: 'Erneut versuchen',
      stages: {
        analyzing: 'Anhänge analysieren…',
        completed: 'Abgeschlossen',
        creatingPdf: 'PDF erstellen…',
        finalizing: 'Abschließen…',
        generating: 'Bericht generieren…',
        preparing: 'Vorbereiten…',
        transcribing: 'Audio transkribieren…',
      },
      startFailed: 'Generierung fehlgeschlagen',
      title: 'KI-Bericht',
    },
    list: {
    ...
    output: {
      open: 'Bericht öffnen',
      openFailed: 'Bericht konnte nicht geöffnet werden',
